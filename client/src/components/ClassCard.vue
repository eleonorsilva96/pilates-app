        ...
        <div class="flex flex-col items-start p-4 gap-2">
            <div class="flex flex-col gap-1 w-full">
                <h3
                    ...
                    Pilates Matt</h3>
                <p class="text-sm text-gray-600">Energizing morning pilates class to start your day</p>
            </div>
            <div class="flex justify-between gap-2 w-full">
                <div class="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-clock w-4 h-4 text-gray-500" data-lov-id="src/pages/ClassesSimple.tsx:186:20"
                        data-lov-name="Clock" data-component-path="src/pages/ClassesSimple.tsx"
                        data-component-line="186" data-component-file="ClassesSimple.tsx" data-component-name="Clock"
                    ...
                    <div class="flex gap-2">
                        <!-- class occurrences -->
                        <span class="text-gray-500 text-sm">8:00</span>
                        <span class="text-gray-500 text-sm">12:00</span>
                        <span class="text-gray-500 text-sm">18:00</span>
                    </div>
                </div>
                <div class="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-calendar w-4 h-4 text-gray-500" data-lov-id="src/pages/ClassesSimple.tsx:190:20"
                        data-lov-name="Calendar" data-component-path="src/pages/ClassesSimple.tsx"
                        data-component-line="190" data-component-file="ClassesSimple.tsx" data-component-name="Calendar"
                        data-component-content="%7B%22className%22%3A%22w-4%20h-4%22%7D">
                        <path d="M8 2v4"></path>
                        <path d="M16 2v4"></path>
                    ...
                    <span class="text-gray-500 text-sm">Tue, Wed, Thur, Fri</span>
                </div>
            </div>
            <div class="flex items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
