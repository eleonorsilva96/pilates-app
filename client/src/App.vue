    ...
    <div class="border-b sticky">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex justify-between h-16">
          <a href="" class="self-center"><span class="font-bold text-xl"><RouterLink to="/">PilatesFlow</RouterLink></span></a>
          <div class="flex space-x-4 items-center">
            <a href="" class="font-medium text-pink-600 dark:text-pink-500 hover:underline"
              ><RouterLink to="/auth/login">Login</RouterLink></a
            >
            <a
              href=""
            ...
            >
              <RouterLink to="/auth/register">Get Started</RouterLink></a
            >
          </div>
        </nav>
      </div>
